...
class Simulation(object):
    ...
    def collect_data(self, vehicles=None):
        ...
        for veh in vehicles:
            ...
            self.add_data(veh, 'time_gap', veh.get_time_headway())
            ...
            self.add_data(veh, 'target_speed', veh.target_speed if hasattr(veh, 'target_speed') else -1)
            self.add_data(veh, 'max_headway', veh.max_headway if hasattr(veh, 'max_headway') else -1)
