...
- Use structured tags for reasoning:
  ...
  - Each observation about the current state should be wrapped in `<observation>` tags.
  - Each deduction from the observations should be wrapped in `<deduction>` tags.
