"""
CONFIG__ {'env': <class 'env.SimpleRoad'>, 'env_config': {'max_accel': 2.6, 'max_decel': 4.5, 'road_length': 50, 'sim_step': 0.1}, 'num_gpus': 0, 'model': {'custom_model': 'my_fcnet', 'vf_share_layers': False}, 'lr': 0.0001, 'num_workers': 1, 'framework': 'torch'}

RESULT__
{
    'episode_reward_max': -1046.0, 'episode_reward_min': -1410.0, 'episode_reward_mean': -1181.6666666666667, 'episode_len_mean': 1181.6666666666667, 'episode_media': {}, 'episodes_this_iter': 3, 'policy_reward_min': {}, 'policy_reward_max': {}, 'policy_reward_mean': {}, 'custom_metrics': {}, 'hist_stats': {'episode_reward': [-1089.0, -1046.0, -1410.0], 'episode_lengths': [1089, 1046, 1410]}, 'sampler_perf': {
        'mean_raw_obs_processing_ms': 0.0599869725943148, 'mean_inference_ms': 0.8076765155291682, 'mean_action_processing_ms': 0.07200705888896429, 'mean_env_wait_ms': 0.03532956940208307, 'mean_env_render_ms': 0.0
    }, 'off_policy_estimator': {}, 'num_healthy_workers': 1, 'timesteps_total': 4000, 'agent_timesteps_total': 4000, 'timers': {
        'sample_time_ms': 3952.961, 'sample_throughput': 1011.9, 'learn_time_ms': 8203.071, 'learn_throughput': 487.622, 'update_time_ms': 1.089
    }, 'info': {
        'learner': defaultdict(<class 'dict'>, {'default_policy': {'learner_stats': {'allreduce_latency': 0.0, 'cur_kl_coeff': 0.2, 'cur_lr': 0.0001, 'total_loss': 2573.663040161133, 'policy_loss': -0.0028401092276908457, 'vf_loss': 2573.6656799316406, 'vf_explained_var': -0.00080793165, 'kl': 0.0009416129105375148, 'entropy': 1.4249331504106522, 'entropy_coeff': 0.0}}}), 'num_steps_sampled': 4000, 'num_agent_steps_sampled': 4000, 'num_steps_trained': 4000}, 'done': True, 'episodes_total': 3, 'training_iteration': 1, 'experiment_id': 'be34245f929046878be05df6ce70a96d', 'date': '2021-04-25_17-12-59', 'timestamp': 1619363579, 'time_this_iter_s': 12.166433811187744, 'time_total_s': 12.166433811187744, 'pid': 89016, 'hostname': 'Nathans-MacBook-Pro.local', 'node_ip': '10.188.47.71', 'config': {'num_workers': 1, 'num_envs_per_worker': 1, 'create_env_on_driver': False, 'rollout_fragment_length': 200, 'batch_mode': 'truncate_episodes', 'train_batch_size': 4000, 'model': {'fcnet_hiddens': [256, 256], 'fcnet_activation': 'tanh', 'conv_filters': None, 'conv_activation': 'relu', 'post_fcnet_hiddens': [], 'post_fcnet_activation': 'relu', 'free_log_std': False, 'no_final_linear': False, 'vf_share_layers': False, 'use_lstm': False, 'max_seq_len': 20, 'lstm_cell_size': 256, 'lstm_use_prev_action': False, 'lstm_use_prev_reward': False, '_time_major': False, 'use_attention': False, 'attention_num_transformer_units': 1, 'attention_dim': 64, 'attention_num_heads': 1, 'attention_head_dim': 32, 'attention_memory_inference': 50, 'attention_memory_training': 50, 'attention_position_wise_mlp_dim': 32, 'attention_init_gru_gate_bias': 2.0, 'attention_use_n_prev_actions': 0, 'attention_use_n_prev_rewards': 0, 'num_framestacks': 'auto', 'dim': 84, 'grayscale': False, 'zero_mean': True, 'custom_model': 'my_fcnet', 'custom_model_config': {}, 'custom_action_dist': None, 'custom_preprocessor': None, 'lstm_use_prev_action_reward': -1, 'framestack': True}, 'optimizer': {}, 'gamma': 0.99, 'horizon': None, 'soft_horizon': False, 'no_done_at_end': False, 'env': 'SimpleRoad', 'env_config': {'max_accel': 2.6, 'max_decel': 4.5, 'road_length': 50, 'sim_step': 0.1}, 'render_env': False, 'record_env': False, 'normalize_actions': False, 'clip_rewards': None, 'clip_actions': True, 'preprocessor_pref': 'deepmind', 'lr': 0.0001, 'log_level': 'WARN', 'callbacks': <class 'ray.rllib.agents.callbacks.DefaultCallbacks'>, 'ignore_worker_failures': False, 'log_sys_usage': True, 'fake_sampler': False, 'framework': 'torch', 'eager_tracing': False, 'explore': True, 'exploration_config': {'type': 'StochasticSampling'}, 'evaluation_interval': None, 'evaluation_num_episodes': 10, 'evaluation_parallel_to_training': False, 'in_evaluation': False, 'evaluation_config': {}, 'evaluation_num_workers': 0, 'custom_eval_function': None, 'sample_async': False, 'sample_collector': <class 'ray.rllib.evaluation.collectors.simple_list_collector.SimpleListCollector'>, 'observation_filter': 'NoFilter', 'synchronize_filters': True, 'tf_session_args': {'intra_op_parallelism_threads': 2, 'inter_op_parallelism_threads': 2, 'gpu_options': {'allow_growth': True}, 'log_device_placement': False, 'device_count': {'CPU': 1}, 'allow_soft_placement': True}, 'local_tf_session_args': {'intra_op_parallelism_threads': 8, 'inter_op_parallelism_threads': 8}, 'compress_observations': False, 'collect_metrics_timeout': 180, 'metrics_smoothing_episodes': 100, 'remote_worker_envs': False, 'remote_env_batch_wait_ms': 0, 'min_iter_time_s': 0, 'timesteps_per_iteration': 0, 'seed': None, 'extra_python_environs_for_driver': {}, 'extra_python_environs_for_worker': {}, 'num_gpus': 0, '_fake_gpus': False, 'num_cpus_per_worker': 1, 'num_gpus_per_worker': 0, 'custom_resources_per_worker': {}, 'num_cpus_for_driver': 1, 'placement_strategy': 'PACK', 'input': 'sampler', 'input_evaluation': ['is', 'wis'], 'postprocess_inputs': False, 'shuffle_buffer_size': 0, 'output': None, 'output_compress_columns': ['obs', 'new_obs'], 'output_max_file_size': 67108864, 'multiagent': {'policies': {}, 'policy_mapping_fn': None, 'policies_to_train': None, 'observation_fn': None, 'replay_mode': 'independent', 'count_steps_by': 'env_steps'}, 'logger_config': None, 'simple_optimizer': True, 'monitor': -1, 'use_critic': True, 'use_gae': True, 'lambda': 1.0, 'kl_coeff': 0.2, 'sgd_minibatch_size': 128, 'shuffle_sequences': True, 'num_sgd_iter': 30, 'lr_schedule': None, 'vf_loss_coeff': 1.0, 'entropy_coeff': 0.0, 'entropy_coeff_schedule': None, 'clip_param': 0.3, 'vf_clip_param': 10.0, 'grad_clip': None, 'kl_target': 0.01, 'vf_share_layers': -1}, 'time_since_restore': 12.166433811187744, 'timesteps_since_restore': 0, 'iterations_since_restore': 1, 'perf': {'cpu_util_percent': 43.88333333333334, 'ram_util_percent': 71.37222222222222}, 'trial_id': 'a6b93_00000', 'experiment_tag': '0'
}
"""
...
class TuneReporterBase(ProgressReporter):
    ...
    def _progress_str(self,
        ...
        messages = ["Status:" + " ; ".join([memory_debug_str(), *sys_info])]
        if done:
            max_progress = None
            max_error = None
        else:
...
def trial_progress_table(
    ...
    columns = (["Trial name", "status"] + formatted_parameter_columns +
