...
if __name__ == '__main__':
    ...
    state_to_cpp_map = {
        ...
        **{f'past_accel_{i}': f'past_accel[{i-1}]' for i in range(1000)},
        **{f'past_requested_speed_setting_{i}': f'past_requested_speed_setting[{i-1}]' for i in range(1000)},
        **{f'past_av_speeds_{i}': f'past_av_speeds[{i-1}]' for i in range(1000)},
        'target_speed': 'target_speed',
        'last_time_leader_was_seen': 'dont_add_this_state',
        'last_time_leader_was_seen2': 'dont_add_this_state',
        'last_time_leader_was_seen3': 'dont_add_this_state',
        'target_speed_200': 'target_speed_200',
        'target_speed_500': 'target_speed_500',
        'target_speed_1000': 'target_speed_1000',
