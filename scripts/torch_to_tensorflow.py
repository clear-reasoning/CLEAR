...
parser.add_argument('--cp_path', type=str, help='Path to the checkpoint you want to convert. This '
                                                'should include the .zip file that you want opened')
...
# the following code can be used to test i/o on an .onnx model
